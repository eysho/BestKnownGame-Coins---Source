...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nichts " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nichtstools.bkg.me", "dnsseed.nichtstools.bkg.me"},
    {"nichtspool.bkg.me", "dnsseed.nichtspool.bkg.me"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"nichtstools.bkg.me", "testnet-seed.nichtstools.bkg.me"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nichts is probably already running."), addrBind.ToString().c_str());
        else
